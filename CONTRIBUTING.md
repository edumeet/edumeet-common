...
5. You should probably get your IDE working with our eslint config. This is an example of `.vscode/settings.json` and it's how I, [pnts-se](https://github.com/pnts-se), personally get it to work on Vscode.
    ...
    ```
6. Create pull request to the main branch of edumeet-common.
### Git hooks
